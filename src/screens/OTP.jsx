            ...
            <SafeAreaView className='flex-1'>
                <KeyboardAvoidingView behavior='height' className="flex-1 items-center justify-center px-4 py-12">
                    <View className='flex-1 mt-6'>
                        <Text className='text-xl font-bold text-purple-900 text-center'>Password Recovery</Text>
                        <Text className='text-base text-purple-700 text-center'>Please enter your email address to recover your password</Text>
                    ...
                    <View className='mt-5 w-full'>
                        <TouchableOpacity
                            ...
                            <Text className='text-center text-purple-50 text-lg'>
                                Send Email
                            </Text>
                        </TouchableOpacity>
